...
<div class="container">
    ...
    {{ Form::open(array('url'=>'/doc/approve-my-cart')) }}
            <!-- Modal -->
    ...
    <div class="pull-right">
        <br>
        <a href="{{ URL::to('/doc/services') }}" style="text-decoration:none; color:#000">
            Home
        </a>
        &nbsp;&nbsp;&nbsp;&nbsp;
        @if(\Auth::guard('docs')->check())
            &nbsp;&nbsp;&nbsp;&nbsp;
            <a href="{{ URL::to('/doc/my-cart') }}" style="text-decoration:none; color:#000">My Cart</a>
        @endif
        &nbsp;&nbsp;&nbsp;&nbsp;
        @if(\Auth::guard('docs')->check())
            <span class="glyphicon glyphicon-user"></span> {{ \Auth::guard('docs')->user()->first_name }} | <a href="{{ URL::to('/doc/logout') }}" style="text-decoration:none; color:#000">Log Out</a>
        @else
            <a href="{{ URL::to('/doc/login') }}" style="text-decoration:none; color:#000">
                Log In/Sign Up
            </a>
        @endif
    </div>
        ...
        <div class="col-md-8">
            ...
            <table class="table">
                ...
                @foreach($my_cart as $my_cart)
                    <tr>
                        <td><a href="{{ URL::to('/doc/remove-from-cart/'.$my_cart->id) }}" style="text-decoration:none;color:#000;"><small><span class="glyphicon glyphicon-remove"></span></a> {{ $my_cart->medicine_name }}</small></td>
            ...
            <div class="pull-right">
                <button type="button" class="btn btn-success" onClick="location.href='/doc/order'">Continue Shopping</button> {{ Form::button('Confirm Order',array('class'=>'btn btn-primary','data-toggle'=>'modal','data-target'=>'#myModal')) }}
            </div>
